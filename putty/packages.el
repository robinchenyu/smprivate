;;; packages.el --- putty Layer packages File for Spacemacs
;;
...
;; (setq putty-excluded-packages '())

;; For each package, define a function putty/init-<package-name>
;;
;; (defun putty/init-my-package ()
...
(message "run putty-fix-keys over")  )
;;
